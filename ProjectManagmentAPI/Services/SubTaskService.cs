...
namespace ProjectManagementAPI.Services
{
    public class SubTaskService : BaseService, ISubTaskService
    {
        ...
        public SubTaskService(
            ...
            ILogger<SubTaskService> logger) : base(logger)
        {
            _context = context;
        ...
        public async Task<ApiResponse<SubTaskResponse>> CreateSubTaskAsync(CreateSubTaskRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка создания подзадачи");
                return ApiResponse<SubTaskResponse>.Fail("Произошла ошибка при создании подзадачи");
            }
        }
        ...
        public async Task<ApiResponse<SubTaskResponse>> GetSubTaskByIdAsync(Guid subTaskId)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка получения подзадачи {SubTaskId}", subTaskId);
                return ApiResponse<SubTaskResponse>.Fail("Произошла ошибка при получении подзадачи");
            }
        }
        ...
        public async Task<ApiResponse<SubTaskResponse>> UpdateSubTaskAsync(Guid subTaskId, UpdateSubTaskRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка обновления подзадачи {SubTaskId}", subTaskId);
                return ApiResponse<SubTaskResponse>.Fail("Произошла ошибка при обновлении подзадачи");
            }
        }
        ...
        public async Task<ApiResponse> DeleteSubTaskAsync(Guid subTaskId)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка удаления подзадачи {SubTaskId}", subTaskId);
                return ApiResponse.Fail("Произошла ошибка при удалении подзадачи");
            }
        }
        ...
        public async Task<ApiResponse<SubTaskResponse>> StartSubTaskAsync(StartSubTaskRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка начала подзадачи {SubTaskId}", request.SubTaskId);
                return ApiResponse<SubTaskResponse>.Fail("Произошла ошибка при начале работы");
            }
        }
        ...
        public async Task<ApiResponse<SubTaskResponse>> CompleteSubTaskAsync(CompleteSubTaskRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка завершения подзадачи {SubTaskId}", request.SubTaskId);
                return ApiResponse<SubTaskResponse>.Fail("Произошла ошибка при завершении подзадачи");
            }
        }
        ...
        public async Task<ApiResponse<SubTaskResponse>> ChangeStatusAsync(Guid subTaskId, ChangeSubTaskStatusRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка изменения статуса подзадачи {SubTaskId}", subTaskId);
                return ApiResponse<SubTaskResponse>.Fail("Произошла ошибка при изменении статуса");
            }
        }
        ...
        public async Task<ApiResponse> ReorderSubTasksAsync(ReorderSubTasksRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка изменения порядка подзадач");
                return ApiResponse.Fail("Произошла ошибка при изменении порядка подзадач");
            }
        }
        ...
        public async Task<ApiResponse<SubTaskStatisticsResponse>> GetSubTaskStatisticsAsync(Guid backlogItemId)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка получения статистики подзадач задачи {BacklogItemId}", backlogItemId);
                return ApiResponse<SubTaskStatisticsResponse>.Fail("Произошла ошибка при получении статистики");
            }
        }
        ...
        public async Task<ApiResponse<BlockerResponse>> AddBlockerToSubTaskAsync(Guid subTaskId, string description, string severity)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка добавления блокера к подзадаче {SubTaskId}", subTaskId);
                return ApiResponse<BlockerResponse>.Fail("Произошла ошибка при добавлении блокера");
            }
        }
