...
namespace ProjectManagementAPI.Services
{
    public class ReportService : IReportService
    {
        ...
        public async Task<byte[]> ExportReportAsync(GenerateReportRequest request)
        {
            ...
            // Формируем CSV/Excel/PDF в зависимости от формата
            return request.Format switch
            {
                ReportFormat.CSV => GenerateCsvReport(reportData),
                ReportFormat.Excel => GenerateExcelReport(reportData),
        ...
        private byte[] GenerateExcelReport(object data)
        {
            ...
            // Используйте библиотеки типа EPPlus или ClosedXML
        ...
        private byte[] GeneratePdfReport(object data)
        {
            ...
            // Используйте библиотеки типа QuestPDF или iTextSharp
            return Array.Empty<byte>();
        }
